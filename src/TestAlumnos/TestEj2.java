...
public class TestEj2 {
	...
	public static void testGen(String filePath) {
		...
		System.out.println("Solución genéticos: \n");
	...
	public static void test2PLE(String filePath) throws IOException {
		DatosEj2Alumnos.leerDatos(filePath);
		System.out.println("Solución PLE: \n");
		...
		System.out.println(SolucionEj2Alumnos.parse(gs.values));
	}
	
	public static void main(String[] args) throws IOException {
		
		testGen("Ficheros/PI5Ej2DatosEntrada1.txt");
		testGen("Ficheros/PI5Ej2DatosEntrada2.txt");
		testGen("Ficheros/PI5Ej2DatosEntrada3.txt");
		test2PLE("Ficheros/PI5Ej2DatosEntrada1.txt");
		test2PLE("Ficheros/PI5Ej2DatosEntrada2.txt");
		test2PLE("Ficheros/PI5Ej2DatosEntrada3.txt");
	}
